...
### [v0.3.2](https://github.com/decodelabs/cipher/commits/v0.3.2) - 21st April 2026

- Upgraded PHP-JWT to v7
- Improved doc comment headers
- Added AGENTS.md
- Integrated Chorus dev dependency

[Full list of changes](https://github.com/decodelabs/cipher/compare/v0.3.1...v0.3.2)

---

### [v0.3.1](https://github.com/decodelabs/cipher/commits/v0.3.1) - 3rd October 2025

- Upgraded Nuance to v0.2
- Simplified CI workflow

[Full list of changes](https://github.com/decodelabs/cipher/compare/v0.3.0...v0.3.1)
...
### [v0.2.5](https://github.com/decodelabs/cipher/commits/v0.2.5) - 1st August 2025

- Upgraded Harvest to v0.6

[Full list of changes](https://github.com/decodelabs/cipher/compare/v0.2.4...v0.2.5)

---

### [v0.2.4](https://github.com/decodelabs/cipher/commits/v0.2.4) - 6th June 2025

- Switched to Nuance for dump handling

[Full list of changes](https://github.com/decodelabs/cipher/compare/v0.2.3...v0.2.4)

---

### [v0.2.3](https://github.com/decodelabs/cipher/commits/v0.2.3) - 21st May 2025

- Removed Tightrope dependency

[Full list of changes](https://github.com/decodelabs/cipher/compare/v0.2.2...v0.2.3)
